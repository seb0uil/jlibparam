...
public class PoolHolder {
	...
	synchronized public static void put(String key, Object o) throws BadClassException {
		put(key,o,ObjectHolder.DEFAULT_TIMEOUT, ObjectHolder.DEFAULT_DEADOUT);
	}
	 ...
	 * @param key clé à associer à l'objet à stocker
	 * @param o objet à stocker dans le pool
	 * @param timeout valeur du timeout a positionner pour l'objet 
	 * @throws BadClassException
	 */
	synchronized public static void put(String key, Object o, Long timeout) throws BadClassException {
		put(key,o,timeout,ObjectHolder.DEFAULT_DEADOUT);
	}
	 ...
	 * @param o objet à stocker dans le pool
	 * @param timeout valeur du timeout a positionner pour l'objet
	 * @param deadout valeur du deadout a positionner pour l'objet
	 * @throws BadClassException
	 */
	synchronized public static void put(String key, Object o, Long timeout, Long deadout) throws BadClassException {
		...
		if (!mapOfObjectAvailable.containsKey(key)) {
			ObjectHolder holder = new ObjectHolder(o,timeout,deadout);
	...
	synchronized public static void putInUsed(String key, Object o) throws BadClassException, AlreadyInUsedException {
		putInUsed(key,o,ObjectHolder.DEFAULT_TIMEOUT,ObjectHolder.DEFAULT_DEADOUT);
	}
	 ...
	 * @throws AlreadyInUsedException 
	 */
	synchronized public static void putInUsed(String key, Object o, Long timeout) throws BadClassException, AlreadyInUsedException {
		putInUsed(key,o,timeout,ObjectHolder.DEFAULT_DEADOUT);
	}
	 ...
	 * @throws AlreadyInUsedException 
	 */
	synchronized public static void putInUsed(String key, Object o, Long timeout, Long deadout) throws BadClassException, AlreadyInUsedException {
		Map<String, ArrayList<ObjectHolder>> mapOfObjectAvailable = getObjectAvailable();
		Map<String, ArrayList<ObjectHolder>> mapOfObjectInUsed = getObjectInUsed();
